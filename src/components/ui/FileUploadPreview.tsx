...
export default function FileUploadPreview({
  ...
  return (
    <div>
      <div className="bg-white rounded-lg border border-natural-100 p-6">
        <h2 className="text-lg font-medium mb-3.5 text-natural-800">{label}</h2>
          ...
          <div>
            ...
            >
              ...
              <p className="text-sm text-gray-500 mt-2 text-center">
                Drag and drop image / video here, or click add image / video
              </p>
              <div>
                <button
                  type="button"
