  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-12 right-4 text-white drop-shadow-lg">
          <p
            className={` font-bold text-3xl transition-transform duration-500 ${isHovered ? "scale-150" : "scale-100"
              }`}
          >
            {name}
          </p>
      ...
      <div
        className={`absolute  ${isHovered ? "top-0" : "top-full"
          }  inset-0 bg-[#d4212c] text-white p-4 flex flex-col justify-between rounded-xl transition-all duration-600`}
      >
